...
class QuickService extends BaseApplicationComponent {
  ...
  // modifyParams('http://www.website.com?foo=bar', 'test');
  ...
  // modifyParams('http://www.website.com?foo=bar', ['foo'=>'jazz', 'ping'=>'pong', 'test']);
  ...
  // modifyParams('http://www.website.com', 'foo', 'bar')
